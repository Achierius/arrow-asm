...
function_definition : FN name=ID parameter_list? '{' function_body '}';
...
unary_operator_instruction  : operator=unary_operator  arg1=any_lvalue ',' arg2=any_argument;
